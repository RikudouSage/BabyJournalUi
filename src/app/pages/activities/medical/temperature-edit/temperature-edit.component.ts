...
@Component({
  ...
  styleUrls: ['./temperature-edit.component.scss']
})
export class TemperatureEditComponent implements OnInit {
  ...
  public form = new FormGroup({
    ...
    temperature: new FormControl<number>(0, [Validators.required, Validators.min(0)]),
  });
  ...
  private activity: TemperatureMeasuringActivity | null = null;
  private currentRoute: string | null = null;

  constructor(
    private readonly titleService: TitleService,
    private readonly translator: TranslateService,
    private readonly repository: TemperatureMeasuringActivityRepository,
  ...
  public async save(): Promise<void> {
    ...
    this.activity.attributes = {
      ...
      temperature: new EncryptedValue(await encrypt(String(this.form.controls.temperature.value))),
    }
  ...
  public async ngOnInit(): Promise<void> {
    ...
    this.route.params.subscribe(async params => {
      ...
      this.form.patchValue({
        ...
        temperature: Number(activity.attributes.temperature.decrypted),
      });
      this.loading = false;
