...
@Component({
  selector: 'app-weighing-edit',
  templateUrl: './weighing-edit.component.html',
  styleUrls: ['./weighing-edit.component.scss']
})
export class WeighingEditComponent implements OnInit {
  ...
  private activity: WeighingActivity | null = null;
  private currentRoute: string | null = null;

  constructor(
    private readonly titleService: TitleService,
    private readonly translator: TranslateService,
    private readonly repository: WeighingActivityRepository,
  ...
  public async save(): Promise<void> {
    ...
    this.activity.attributes = {
      ...
      weight: new EncryptedValue(await encrypt(String(this.form.controls.weight.value))),
    }
  ...
  public async ngOnInit(): Promise<void> {
    ...
    this.route.params.subscribe(async params => {
      ...
      this.form.patchValue({
        ...
        weight: Number(activity.attributes.weight.decrypted),
      });
      this.loading = false;
